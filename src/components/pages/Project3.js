    ...
    <PageWrapper>
      ...
      <ContentWrapper>
        ...
        <p>
          ...
          수 있는 서비스이다. 기도를 기록하고, 다른 사람들과 공유할 수 있으며,
          기도를 저장하는 등의 기도 기록과 관련된 전반적인 기능을 구현하였다.
        </p>
        <p>
          또한 저희 Uspray 팀은 대표자와 9명의 개발팀, 그리고 5명의
          비전전략팀으로 구성되어 총 15명이 함께하고 있다. 팀원들은 학교 수업,
          대외 활동, 인턴, 개인 프로젝트 등을 통해 다양한 개발 실력과 서비스
          운영 지식을 습득해 왔으며, 각자의 역량을 활용하여 애플리케이션 제작과
          서비스 운영에 기여하고 있다.
        </p>
        <p>
        ...
        <p>
          ...
          기능 및 디자인 구현 등의 직무를 맡았다. 그 중에서도 특히 과거 기도
        ...
        <p>
          ...
          다양한 조건으로 기도를 검색할 수 있는 ‘검색 기능’ 등이 존재한다.
        </p>
        <p>
          ...
          제공하고자 노력했다. 그 결과 기도 내역을 효과적으로 추가, 삭제할 수
          있으며, 검색 기능을 통해 빠르게 원하는 기도 정보를 찾을 수 있도록
          기능을 구현하였다.
        </p>
        <p>
          ...
          최적화가 필요하다. 따라서 데이터 로딩 및 처리 속도를 개선하기 위해
          비동기 처리 및 페이징 등의 기술을 도입할 예정이다.
        </p>
        ...
        <p>
          ...
          보관함에서 삭제할 수 있는 ‘기도 삭제’ 기능 등이 존재한다.
        </p>
        <p>
          보관함도 리액트를 사용하여 각 기능을 모듈화하여 재사용성을 높였으며,
          Context API를 이용해서 컴포넌트 간의 데이터 공유 및 전달을 관리했습다.
          그리고 여러 화면이나 컴포넌트 간의 전환 시에 부드러운 애니메이션을
          적용하여 사용자 경험을 향상시키고자 노력했다. 이러한 점을 통해
          사용자가 손쉽게 공유받은 기도를 보관하고 필요한 경우 저장 및 삭제할 수
          있도록 기능이 구현되었다.
        </p>
        <p>
        ...
        <p>
          ...
          과정에서 다양한 도전에 직면하고 극복해왔다. 특히, 디자인팀, 기획팀과의
          협력을 통해 효율적인 작업 방식과 목표 달성에 대한 중요성을 체감하였다.
        </p>
        <p>
          ...
          활동을 통해 지난 실패에서 배운 교훈을 적극적으로 활용하고 있다. 창업에
          대한 열정과 지식이 점차 증가하고 있으며, 이를 통해 성공적인 창업을
          위한 기반이 열심히 쌓는 계기가 되었다.
        </p>
        <p>
          ...
          토대로 현재는 인공지능에 관심을 가져 열심히 학습하는 중이다. 또한 개인
          프로젝트를 제외하곤 팀 프로젝트를 해보지 않았는데 팀 내부 기획팀,
