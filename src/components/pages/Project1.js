    ...
    <PageWrapper>
      ...
      <ContentWrapper>
        ...
        <p>
          ...
          과정이었습니다. 이 과정의 주요 목표는 다양한 데이터로부터 유용한
          통찰력을 얻어 불량을 탐색함으로써 기지국 장비 성능을 향상시키는데
          도움을 주고, 데이터 분석 기술을 향상시키는 것이었습니다.
        </p>
        ...
        <p>
          ...
          수집한 기지국 장비의 성능 데이터를 전처리하는 과정을 진행했습니다.
          실제 데이터 분석 작업의 핵심인 이 과정에서 다른 형식으로 되어 있는 Raw
          데이터를 하나의 데이터로 효과적이고 일관성 있게 통합하고, 보간법을
          이용한 데이터의 결측치를 처리하여 데이터 품질을 높혔습니다. 그리고
          이러한 데이터를 정규화와 표준화를 통해 변수들의 값의 범위를 비슷하게
          만들어 주었습니다. 두 번째로 시계열 데이터 EDA를 통한 이상치 탐지
          과정입니다. 정규성 확인, 상관계수나 산점도 등을 통한 변수 사이의
          상관성 확인, STL 기법, 자기상관, 그리고 행렬 프로파일 등 다양한 기법을
          사용하여 시계열 데이터의 이상치나 주기성을 파악했습니다. 더 나아가
          ARIMA 시계열 예측과 같은 기계학습 알고리즘을 통해 이상치 탐지를 하는
          방법을 학습했습니다.
        </p>
        ...
        <p>
          ...
          개념과 기술을 제공했습니다. 이 교육 과정에서 데이터 수집, 정제,
          시각화, 통계 분석, 머신 러닝 등의 기술을 활용하여 실무에서 발생하는
          문제에 대한 해결책을 개발하는 과정을 이해하고 이를 적용하는 경험을
          하였습니다. 또한, 프로그래밍 및 데이터 분석 도구를 활용하여 실무의
          많은 양의 데이터로 작업하는 경험을 쌓을 수 있었습니다.
        </p>
        <p>
          이번 프로젝트를 하면서 추상적으로만 이해하고 있던 데이터 분석은 실제
          비즈니스 의사 결정에 큰 도움이 된다는 점을 깨달았습니다. 데이터를 통해
          문제를 해결하고 개선점을 발견하는 과정이 매우 흥미로웠습니다. 데이터
          분석 과정에 대해 추상적으로 생각만 하고 배우고 싶다는 단순한 생각만
          있었는데 이번 프로젝트를 통해 전체적인 데이터 분석의 흐름을 이해할 수
          있어 좋았고, 한편으로는 입문자 과정이다보니 새로 알아 가는 게 아무래도
          많을 순 없었다는 아쉬움은 조금 존재했습니다.
        </p>
        ...
        <p>
          ...
          적용하고자 했습니다. 지난 학기에 들은 인공지능 관련 수업 지식을
          기반으로 하여 데이터 수집이나 분석에 대한 공부를 추가적으로 진행했고,
          관심 있는 분야에 대한 논문 리뷰 위주로 블로그 글을 작성하고 있습니다.
          더 나아가 관련 대회나 다른 사람들과의 협업을 통해서 소통 능력을
          기르고, 데이터 사이언스의 최신 동향도 꾸준히 파악하고 적용해 나갈
          것입니다.
        </p>
      </ContentWrapper>
    </PageWrapper>
