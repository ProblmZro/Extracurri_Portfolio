      ...
      <PageWrapper>
        ...
        <ContentWrapper>
          ...
          <p>
            ...
            과정이었다. 이 과정의 주요 목표는 다양한 데이터로부터 유용한
            통찰력을 얻어 불량을 탐색함으로써 기지국 장비 성능을 향상시키는데
            도움을 주고, 데이터 분석 기술을 향상시키는 것이었다.
          </p>
          ...
          <p>
            이번 프로젝트는 동영상 강의를 통해 개념을 배우고 직접 코드로
            실습하여 결과를 확인한 후, 중간중간 퀴즈로 자신의 실력을 점검하는
            순서로 진행되었다.
          </p>
          ...
          <p>
            ...
            이용한 데이터의 결측치를 처리하여 데이터 품질을 높혔다. 그리고
            이러한 데이터를 정규화와 표준화를 통해 변수들의 값의 범위를 비슷하게
            만들어 주었다. 두 번째로 시계열 데이터 EDA를 통한 이상치 탐지
            과정이다. 정규성 확인, 상관계수나 산점도 등을 통한 변수 사이의
            상관성 확인, STL 기법, 자기상관, 그리고 행렬 프로파일 등 다양한
            기법을 사용하여 시계열 데이터의 이상치나 주기성을 파악했다. 더
            나아가 ARIMA 시계열 예측과 같은 기계학습 알고리즘을 통해 이상치
            탐지를 하는 방법을 학습했다.
          </p>
          ...
          <p>
            이러한 프로젝트 진행 과정 사이에 중간 퀴즈로 실력을 점검하고
            부족했던 개념에 대해 파악할 수 있었고, 최종 프로젝트 퀴즈를 통해서
            프로젝트 일련의 과정을 이해할 수 있었습니다.
          </p>
          ...
          <p>
            ...
            문제를 해결하고 개선점을 발견하는 과정이 매우 흥미로웠다. 데이터
            분석 과정에 대해 추상적으로 생각만 하고 배우고 싶다는 단순한 생각만
            있었는데 이번 프로젝트를 통해 전체적인 데이터 분석의 흐름을 이해할
            수 있어 좋았고, 한편으로는 입문자 과정이다보니 새로 알아 가는 게
            아무래도 많을 순 없었다는 아쉬움은 조금 존재했다.
          </p>
          ...
          <p>
            ...
            구체적으로 데이터 과학 및 머신 러닝 분야에서 더 깊은 지식을 쌓고,
            실제 개인 프로젝트를 진행해서 데이터 수집부터의 모든 과정을 스스로
            적용하고자 했다. 지난 학기에 들은 인공지능 관련 수업 지식을 기반으로
            하여 데이터 수집이나 분석에 대한 공부를 추가적으로 진행했고, 관심
            있는 분야에 대한 논문 리뷰 위주로 블로그 글을 작성하고 있다. 더
            나아가 관련 대회나 다른 사람들과의 협업을 통해서 소통 능력을 기르고,
            데이터 사이언스의 최신 동향도 꾸준히 파악하고 적용해 나갈 것이다.
          </p>
        </ContentWrapper>
      </PageWrapper>
    </motion.div>
